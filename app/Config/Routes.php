...
$routes->group('/api/v1', ['namespace' => 'App\Controllers'], function ($routes) {
    ...
    // Profile Routes
    $routes->post('profile/update/1', 'ProfileController::updateUser');
    $routes->post('profile/update/2', 'ProfileController::updateProfile');
    $routes->post('profile/update/3', 'ProfileController::updateAdresse');
